...
const animal1 = Object.create(animalProto).init('Zuri', 'Zebra');
const animal2 = Object.create(animalProto).init('Gigi', 'Giraffe');
...
const dogA = Object.create(dogProto).init('Milo', 'Beagle');
console.log('\n--- Dog Instances ---');
...
const guardDog = Object.create(guardDogProto).init('Thor', 'Rottweiler', 'Advanced');
console.log('\n--- Guard Dog Instance ---');
